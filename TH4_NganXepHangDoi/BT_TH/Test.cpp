...
int main() {
    Init();
    cout << "Đảo số của 12345: " << Reverse(12345) << endl;
    cout << "Kiểm tra 'madam' có đối xứng không: " << (IsPalindrome("madam") ? "Có" : "Không") << endl;
    cout << "Số 10 đổi sang nhị phân: "; DecimalToBinary(10);
    
    char postfix[] = "23 34 + 2 *";
    cout << "Giá trị của biểu thức hậu tố: " << Evaluate(postfix) << endl;
